...
<!-- end navigation -->
    ...
    <div class="front-content text-center">
        ...
        <div class="footer">
            <p>&copy; 2024 Travel Job  Farmer Producer Company Limited  | Design by <a href="https://vyaparkranti.com">Vyapar Kranti</a></p>
        </div>
        <!-- /FOOTER -->
    </div>
</div>
...
.comming-soon > .footer-whatsapp{display: none}
.hero {
font-family: jost;
