...
.custom-container, .offerings-container {
    ...
    <a href="{{ route('productPage') }}" class="quick-nav-card d-block text-decoration-none shadow-sm rounded-3 overflow-hidden">
        ...
        <div class="quick-nav-content p-4">
            ...
            <p class="text-muted mb-0">Discover exciting career opportunities and find your next TravelJob adventure.</p>
        </div>
    </a>
</div>
            <div class="col-md-6">
    ...
    <section class="testimonial pt-5 pb-4">
        <div class="custom-container">
            <div class="site-title pb-3">
                ...
                <p class="text-center text-white">Include quotes or stories from farmers who have benefited from <b>TravelJob  FPO's</b> services.</p>
            </div>
