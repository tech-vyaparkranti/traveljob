  ...
  <form>
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <div class="radio-group">
          <label class="mr-3"><input type="radio" name="acc_record_transactions" value="Yes"> Yes</label>
      ...
      <div class="form-group col-md-6">
        ...
        <div class="radio-group">
          <label class="mr-3"><input type="radio" name="acc_bank_cc_reconciliation" value="Yes"> Yes</label>
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <div class="radio-group">
          <label class="mr-3"><input type="radio" name="acc_corporate_card_reconciliation" value="Yes"> Yes</label>
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-6">
        ...
        <div class="radio-group">
          <label class="mr-3"><input type="radio" name="acc_manage_financial_records" value="Yes"> Yes</label>
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <div class="radio-group">
          <label class="mr-3"><input type="radio" name="acc_software_excel_proficient" value="Yes"> Yes</label>
      ...
      <div class="form-group col-md-6">
        ...
        <div class="radio-group">
          <label class="mr-3"><input type="radio" name="acc_prepare_analyze_reports" value="Yes"> Yes</label>
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <div class="radio-group">
          <label class="mr-3"><input type="radio" name="acc_process_payroll_expenses" value="Yes"> Yes</label>
      ...
      <div class="form-group col-md-6">
        ...
        <div class="radio-group">
          <label class="mr-3"><input type="radio" name="acc_calculate_pay_taxes" value="Yes"> Yes</label>
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <div class="radio-group">
          <label class="mr-3"><input type="radio" name="acc_coordinate_auditors" value="Yes"> Yes</label>
      ...
      <div class="form-group col-md-6">
        ...
        <div class="radio-group">
          <label class="mr-3"><input type="radio" name="acc_monitor_cashflow_forecast" value="Yes"> Yes</label>
