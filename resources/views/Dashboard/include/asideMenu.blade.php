            ...
            <ul class="menu-inner py-1">
              ...
              <li class="menu-item">
                <a href="{{route("slider")}}" class="menu-link">
                  ...
                  <div data-i18n="Analytics">Manage Slider</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="{{route("manageAboutUs")}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-images"></i>
               ...
               <li class="menu-item">
                <a href="{{route("jobseekersdatapage")}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-images"></i>
              ...
              <li class="menu-item" >
                <a href="{{route("managesetting")}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-message-detail"></i>
