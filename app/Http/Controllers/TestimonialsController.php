...
class TestimonialsController extends Controller
{
    ...
    {
        $checkDuplicate = TestimonialsModel::where([
        ...
        if ($checkDuplicate) {
            ...
            $maxId = empty($request->input(TestimonialsModel::ITEM_PRIORITY)) ? TestimonialsModel::max(TestimonialsModel::ID) + 1 : $request->input(TestimonialsModel::ITEM_PRIORITY);
    ...
    public function updateData(TestimonialsRequest $request)
    {
        ...
        if (!$updateModel) {
            return $this->returnMessage("Testimonial not found.", false);
        }
    ...
    public function getHomePageTestimonials()
    {
        $testimonials = Cache::rememberForever('testimonials', function () {
            ...
            ->select(TestimonialsModel::REVIEW_TEXT, TestimonialsModel::CLIENT_NAME)
            ->orderBy(TestimonialsModel::ITEM_PRIORITY, "asc")
            ->get();
        });
